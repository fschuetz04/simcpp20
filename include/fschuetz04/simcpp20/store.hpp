...
/**
 * A store that holds values and provides asynchronous get operations.
 *
 * The store can be optionally capped at a maximum number of items.
 *
 * @tparam T Type of items to store.
 */
